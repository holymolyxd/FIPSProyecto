...
@section('title', 'Historial de la publicacion')

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/posts') }}"><i class="fas fa-address-card"></i> Publicaciones</a>
    </li>
@endsection
...
@section('content')
    <div class="container-fluid">
        <div class="panel shadow">
            <div class="header">
                <h2 class="title"><i class="fas fa-history"></i> Historial de la Publicacion</h2>
            </div>

        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <h1 style="font-size: 162px; color: rgb(208, 0, 0)"><strong>403</strong></h1>
                    <h2>Página encontrada</h2>
                    <p class="display-5">No cumples con los permisos necesarios para acceder a ella.</p>
